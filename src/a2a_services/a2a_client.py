...
from src.constants import QUIZ_SERVICE_URL, DEFAULT_TIMEOUT,STUDY_BUDDY_URL
...
def delegate_quiz_task(
    ...
    Args:
        ...
        answers: Optional list of pre-collected answers.If None or empty, service returns questions only.

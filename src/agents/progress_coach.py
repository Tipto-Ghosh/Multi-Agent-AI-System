...
from src.constants import MODEL_NAME, OLLAMA_BASE_URL, PASS_THRESHOLD, USE_A2A_QUIZ,QUIZ_SERVICE_URL
...
def try_a2a_quiz_delegation(topic: str, explaination: str, answers: list[str]) -> dict | None:
    ...
    try:
        ...
        if not is_quiz_service_available(quiz_service_url = QUIZ_SERVICE_URL):
